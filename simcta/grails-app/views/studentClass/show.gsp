...
<html>
    ...
    <body>
        ...
        <div id="show-studentClass" class="content scaffold-show" role="main">
            ...
            <g:form resource="${this.studentClass}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.studentClass}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
