...
<html>
    <head>
        ...
        <title><g:message code="clas.list.label" args="[entityName]" /></title>
    </head>
    <body>
        ...
        <div class="nav" role="navigation">
            <ul>
                ...
                <li><g:link class="list" action="showDeactivated"><g:message code="clas.list.deactivated.label" args="[entityName]" /></g:link></li>
            </ul>
        </div>
        <div id="list-clas" class="content scaffold-list" role="main">
            <h1><g:message code="clas.list.label" args="[entityName]" /></h1>
