...
<html>
    ...
    <body>
        ...
        <div id="show-serviceItem" class="content scaffold-show" role="main">
            ...
            <f:display bean="serviceItem" />
            <g:form resource="${this.serviceItem}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.serviceItem}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
