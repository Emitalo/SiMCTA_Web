...
<html>
    <head>
        ...
        <g:set var="entityName" value="${message(code: 'teacher.label', default: 'Clas')}" />
        <title><g:message code="teacher.list.deactivated.label" args="[entityName]" /></title>
    </head>
    <body>
        ...
        <div id="list-clas" class="content scaffold-list" role="main">
            <h1><g:message code="teacher.list.deactivated.label" args="[entityName]" /></h1>
