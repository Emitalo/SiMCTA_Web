...
<html>
    <head>
        ...
        <title><g:message code="teacher.list.label" args="[entityName]" /></title>
    </head>
    <body>
        ...
        <div class="nav" role="navigation">
            <ul>
                ...
                <li><g:link class="list" action="showDeactivated"><g:message code="teacher.list.deactivated.label" args="[entityName]" /></g:link></li>
            </ul>
        </div>
        <div id="list-teacher" class="content scaffold-list" role="main">
            <h1><g:message code="teacher.list.label" args="[entityName]" /></h1>
            ...
            <div class="pagination">
                <g:paginate total="${teacherCount ?: 0}" />
            </div>
        </div>
    </body>
</html>