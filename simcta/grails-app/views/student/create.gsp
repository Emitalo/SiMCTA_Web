...
<html>
    <head>
        ...
        <title><g:message code="student.create.label" args="[entityName]" /></title>
    </head>
    <body>
        ...
        <div id="create-student" class="content scaffold-create" role="main">
            <h1><g:message code="student.create.label" args="[entityName]" /></h1>
            ...
            <g:form action="save">
                ...
                <fieldset class="buttons">
                    <g:submitButton name="create" class="save" value="${message(code: 'student.button.create.label', default: 'Create')}" />
                </fieldset>
            </g:form>
        </div>
    </body>
