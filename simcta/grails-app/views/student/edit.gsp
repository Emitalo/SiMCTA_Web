...
<html>
    <head>
        ...
        <title><g:message code="student.edit.label" args="[entityName]" /></title>
    </head>
    <body>
        ...
        <div id="edit-student" class="content scaffold-edit" role="main">
            <h1><g:message code="student.edit.label" args="[entityName]" /></h1>
            ...
            <g:form resource="${this.student}" method="PUT">
                ...
                <fieldset class="buttons">
                    <input class="save" type="submit" value="${message(code: 'student.button.update.label', default: 'Update')}" />
                </fieldset>
            </g:form>
        </div>
    </body>
